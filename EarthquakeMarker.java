...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	private static int shallRed = 255, shallGreen = 255, shallBlue = 0;
	private static int intRed = 0, intGreen = 0, intBlue = 255;
	private static int deepRed = 255, deepGreen = 0, deepBlue = 0;
	...
	private void colorDetermine(PGraphics pg) {
		...
		if (depth < THRESHOLD_INTERMEDIATE) {
			pg.fill(shallRed, shallGreen, shallBlue);
		}
		else if (depth < THRESHOLD_DEEP) {
			pg.fill(intRed, intGreen, intBlue);
		}
		else {
			pg.fill(deepRed, deepGreen, deepBlue);
		}
	}
	
	public static void updateShallowColor(int r, int g, int b) {
		shallRed = r;
		shallGreen = g;
		shallBlue = b;
	}
	public static void updateIntermediateColor(int r, int g, int b) {
		intRed = r;
		intGreen = g;
		intBlue = b;
	}
	public static void updateDeepColor(int r, int g, int b) {
		deepRed = r;
		deepGreen = g;
		deepBlue = b;
	}
